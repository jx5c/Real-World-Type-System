...
public class IntervalAnalysisActionInJavaEditor implements IEditorActionDelegate {
	...
	public IntervalAnalysisActionInJavaEditor() {
		super();
	}
	...
	public void setActiveEditor(IAction arg0, IEditorPart editorPart) {
		if(editorPart!=null){
			...
			if (editorInput instanceof IFileEditorInput) {
				...
				this.ifile = IntervalAnalysisActionInJavaEditor.this.thisFileEditorInput.getFile();
			}
		}
	}
