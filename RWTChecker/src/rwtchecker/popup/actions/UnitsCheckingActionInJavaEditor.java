...
public class UnitsCheckingActionInJavaEditor implements IEditorActionDelegate {
	...
	public UnitsCheckingActionInJavaEditor() {
		super();
	}
	...
	public void setActiveEditor(IAction arg0, IEditorPart editorPart) {
		if(editorPart!=null){
			...
			if (editorInput instanceof IFileEditorInput) {
				...
				this.ifile = UnitsCheckingActionInJavaEditor.this.thisFileEditorInput.getFile();
			}
		}
	}
