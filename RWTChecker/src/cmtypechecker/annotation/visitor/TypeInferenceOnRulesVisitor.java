package cmtypechecker.annotation.visitor;
...
import cmtypechecker.popup.actions.TypePropagationProjectInNavigator;
import cmtypechecker.popup.actions.TypePropagationProjectInNavigator.PropagatedMethodsSigniture;
import cmtypechecker.util.CMModelUtil;
import rwtchecker.views.RWTView;

public class TypeInferenceOnRulesVisitor extends TypeInferenceVisitor {
	...
	public TypeInferenceOnRulesVisitor(CompilationUnit compilationUnit) {
